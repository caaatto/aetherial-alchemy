...
export const recipeTree = {
  ...
  recipes: [
    ...
    },
    {
      ...
      icon: '💗',
      rarity: 'Uncommon',
      effect: 'Heals 1d4 HP per round for 10 rounds',
      dc: 12,
      brewTime: '3 hours',
      cost: 1,
      position: { x: 0.5, y: 2 },
    ...
    },
    {
      ...
      icon: '❤️',
      rarity: 'Rare',
      effect: 'Heals 2d4 HP per round for 1 minute',
      dc: 16,
      brewTime: '10 hours',
      cost: 2,
      position: { x: 0.5, y: 3 },
    ...
    },
    {
      ...
      icon: '💛',
      rarity: 'Legendary',
      effect: 'Fully heals, removes all negative conditions',
      dc: 23,
      brewTime: '7 days',
      cost: 5,
      position: { x: 1, y: 4 },
    ...
    },
    {
      ...
      icon: '✨',
      rarity: 'Legendary',
      effect: 'Full heal + Regenerates lost limbs + Rejuvenation',
      dc: 27,
      brewTime: '21 days',
      cost: 10,
      position: { x: 1, y: 5 },
    ...
    // ========== HYBRID HEALING POTIONS ==========
    {
      ...
      icon: '🔥',
      rarity: 'Rare',
      effect: 'Heals 4d4+4 HP + Fire Resistance 1 hour',
      dc: 16,
      brewTime: '8 hours',
      cost: 2,
      position: { x: 1.5, y: 3 },
    ...
    },
    {
      ...
      icon: '❄️',
      rarity: 'Rare',
      effect: 'Heals 4d4+4 HP + Cold Resistance 1 hour',
      dc: 16,
      brewTime: '8 hours',
      cost: 2,
    ...
    },
    {
      ...
      icon: '🐉',
      rarity: 'Very Rare',
      effect: 'Can use Dragon Breath 3x (8d6 fire damage)',
      dc: 20,
      brewTime: '24 hours',
      cost: 3,
    ...
    },
    {
      ...
      icon: '🐲',
      rarity: 'Legendary',
      effect: 'Transforms into a dragon for 10 minutes',
      dc: 25,
      brewTime: '14 days',
      cost: 5,
      position: { x: 3.25, y: 4 },
    ...
    },
    {
      ...
      icon: '🌑',
      rarity: 'Very Rare',
      effect: 'Can teleport through shadows 3x (60ft)',
      dc: 18,
      brewTime: '16 hours',
      cost: 3,
      position: { x: 5, y: 3 },
    ...
    },
    {
      ...
      icon: '✨',
      rarity: 'Legendary',
      effect: 'Invisibility that cannot be broken, 1 hour',
      dc: 27,
      brewTime: '14 days',
      cost: 5,
      position: { x: 4.5, y: 4 },
    ...
    },
    {
      ...
      icon: '🌚',
      rarity: 'Legendary',
      effect: 'Control over shadows, like the Shadow of Moil spell',
      dc: 24,
      brewTime: '10 days',
      cost: 4,
      position: { x: 5.5, y: 4 },
