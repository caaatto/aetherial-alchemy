...
export const herbsDatabase = {
  ...
  wolfsfarn: {
    ...
    description: 'Silvrige Blätter, die im Mondlicht schimmern und eine schwache Lumineszenz aufweisen, wenn sie Mana ausgesetzt werden. Potente Heilungseigenschaften, wertvoll für Zauberkundige. Repräsentiert Schutz in Elfen-Tradition. Delicate Wurzeln erfordern vorsichtige Sammlung.',
    location: 'Wälder und Wiesen des Königreichs Tundral',
    manaContent: 3,
    properties: {
      healing: 'medium',
      stability: 'high',
  ...
  feuerblute: {
    ...
    description: 'Leuchtend rot-orange Blütenblätter die wie Flammen im Wind flackern. Gezackte, feuerrote Blätter. Scharfer, pfeffriger Duft mit erdigen Untertönen. Erzeugt Hitze-Ausbruch beim Zerdrücken, wie glühende Kohle. Wächst in vulkanischen Umgebungen nahe heißer Quellen und schlafender Vulkane.',
    location: 'Vulkanische Regionen, heiße Quellen, Hochgebirge',
    manaContent: 2,
    properties: {
  ...
  eisenkraut: {
    ...
    description: 'Dicke, eisengraue Stängel mit kleinen lila Blütentrauben. Gezackte Blätter mit leichtem metallischem Glanz. Natürliche antiseptische Eigenschaften für Wunden und Infektionen. Als Tee gebraut stärkt es den Körper gegen Erschöpfung und Stress. Beliebt bei Soldaten und Reisenden.',
    location: 'Wilde Wiesen und Waldränder der Königreiche',
    manaContent: 0,
    properties: {
  ...
  schattenkraut: {
    ...
    description: 'Dunkelgrünes Laub mit zarten, mitternachtsblauen Blüten die in Dämmerung schwach leuchten. Duale Natur: mächtiges Toxin oder Heilmittel je nach Zubereitung. Richtig verarbeitet verbessert es Mana-Regeneration oder dient als Gegengift. Falsche Handhabung verursacht schwere Halluzinationen oder Tod. Begehrt bei Spionen, Assassinen und Schurken-Magiern.',
    location: 'Schattige Unterwuchs dichter Wälder, abgelegene Täler',
    manaContent: 5,
    properties: {
      stealth: 'medium',
      shadow: true,
  ...
  mondkresse: {
    ...
    rarity: 'Common',
    categories: ['Medicinal', 'Magical', 'Brewing/Crafting'],
    description: 'Silbrige Blätter mit zarten, sternförmigen Blüten die unter Mondlicht aufblühen. Schwache Lumineszenz macht es beliebt für nächtliche Heilmittel und Rituale. Besonders wirksam bei Verbrennungen und kleineren Wunden als Umschlag. Verstärkt Mana-Regeneration wenn eingenommen. Ätherische Erscheinung etabliert es als fundamentale Ressource im Haushalt und arkaner Praxis.',
    location: 'Schattige Bereiche nahe Bächen und Waldlichtungen',
    manaContent: 4,
    properties: {
      lunar: true,
      night_vision: 'low',
